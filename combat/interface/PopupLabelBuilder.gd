...
func spawn_label_number(new_value : int, old_value : int, battler : Combatant, type : String) -> void:
...
func spawn_label(message : String, battler : Combatant, type : String) -> void:
